...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { first_name: @actor.first_name, last_name: @actor.last_name } }, as: :json
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { first_name: @actor.first_name, last_name: @actor.last_name } }, as: :json
    assert_response 200
  end
